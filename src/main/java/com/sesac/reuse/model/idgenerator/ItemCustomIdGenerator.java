package com.sesac.reuse.model.idgenerator;
...
public class ItemCustomIdGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
        ...
        String categoryId = String.valueOf(item.getCategory().getCategory_id()); // 카테고리 ID 가져오기

        System.out.println("entity:" + entity.getItem().getItem_id());
